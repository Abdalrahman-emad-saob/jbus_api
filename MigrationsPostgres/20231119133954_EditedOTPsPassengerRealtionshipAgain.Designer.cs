...
namespace datamigrations
{
    ...
    [Migration("20231119133954_EditedOTPsPassengerRealtionshipAgain")]
    partial class EditedOTPsPassengerRealtionshipAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OTP", b =>
                {
                    b.HasOne("API.Entities.Passenger", null)
                        .WithMany("OTPs")
                        .HasForeignKey("PassengerId");
                });
            ...
            modelBuilder.Entity("API.Entities.Trip", b =>
                {
                    ...
                    b.HasOne("API.Entities.Point", null)
                        .WithMany("EndingPoints")
                        .HasForeignKey("PointId");

                    b.HasOne("API.Entities.Point", null)
                        .WithMany("StartingPoints")
            ...
            modelBuilder.Entity("API.Entities.Point", b =>
                {
                    b.Navigation("EndingPoints");

                    b.Navigation("FavoritePoint");

                    b.Navigation("InterestPoint");

                    b.Navigation("StartingPoints");
                });
